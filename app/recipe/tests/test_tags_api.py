...
TAGS_URL_LIST = reverse('recipe:tag-list')
...
class PublicTagsAPITests(TestCase):
    ...
    def test_auth_required(self):
        ...
        res = self.client.get(TAGS_URL_LIST)
...
class PrivateTagAPITests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        """Test tags is limited to authenticated user only."""
    ...
    def test_filter_tags_assigned_to_recipes(self):
        """Test listing of tags which are assigned to Recipes."""
        ...
        res = self.client.get(TAGS_URL_LIST, {'assigned_only': 1})
